...
{
	return [self isEqualToDateIgnoringTime:[[NSDate dateTomorrow] dateByAddingDays:1]];
}
...
{
	return [self isEqualToDateIgnoringTime:[[NSDate dateYesterday] dateBySubtractingDays:1]];
}
